...
| `proxy-nginx` | `nginx:1.27-alpine` | Serves static files + proxies PHP to `nextcloud-app:9000` (AIO-style runtime model). Singleton - lives in `compose.db.yaml` alongside the other singletons |
